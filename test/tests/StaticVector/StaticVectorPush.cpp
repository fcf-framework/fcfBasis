...
void staticVectorPushTest(){
  ...
  {
    typedef fcf::StaticVector<StaticVectorPushTestItem, 8, 8, 2, 0, 55> static_vector_type;
    {
  ...
  {
    typedef fcf::StaticVector<StaticVectorPushTestItem, 8, 8, 2, 0, 56> static_vector_type;
    {
  ...
  {
    typedef fcf::StaticVector<StaticVectorPushTestItem, 2, 2, 1, 0, 8> static_vector_type;
    ...
    g_staticVectorPushTestItem_destructCounter = 0;
    {
      ...
      for(size_t i = 0; i < 10; ++i) {
        v.push_back(i);
        size_t c = std::ceil((double)(i+1) / 2);
        c *= 2;
        if (c < 2){
          c = 2;
        }
    ...
    g_staticVectorPushTestItem_destructCounter = 0;
    {
      ...
      for(size_t i = 0; i < 10; ++i) {
        v.pop_back();
        size_t c = std::ceil((double)(10 - i - 1) / 2);
        c *= 2;
        if (c < 2){
          c = 2;
        }
