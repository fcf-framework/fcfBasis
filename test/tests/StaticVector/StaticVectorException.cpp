...
void staticVectorExceptionTest(){
  ...
  {
    typedef fcf::StaticVector<FcfTest::StaticVectorExceptionTest::Item, 2, 2, 2, 0, 0> static_vector_type;
  ...
  {
    typedef fcf::StaticVector<FcfTest::StaticVectorExceptionTest::Item, 8, 2, 1, 0, 0> static_vector_type;
  ...
  {
    typedef fcf::StaticVector<FcfTest::StaticVectorExceptionTest::Item, 2, 2, 1, 0, 0> static_vector_type;
    FcfTest::StaticVectorExceptionTest::g_exceptValue = 0;
    FcfTest::StaticVectorExceptionTest::g_initCounter = 0;
    static_vector_type v1(4);
    v1[0].value = 1;
