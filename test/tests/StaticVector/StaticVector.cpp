...
void staticVectorTest(){
  ...
  {
    typedef fcf::StaticVector<int, 8, 2, 1, 0, 1024> static_vector_type;
  ...
  {
    typedef fcf::StaticVector<int, 8, 8, 2, 0, 56> static_vector_type;
  ...
  {
    typedef fcf::StaticVector<StaticVectorTestItem, 2, 2, 1, 0, 0> static_vector_type;
    int counter = 0;
