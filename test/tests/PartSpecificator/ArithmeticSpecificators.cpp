    ...
    FCF_TEST_DECLARE("fcfBasis", "Specificator", "arithmetic specificators"){
      {
        ...
        int result = 0;
        fcf::Type<int>().specificatorUniversalCall<fcf::SubSpecificator>()(&result, &args[0], sizeof(args) / sizeof(args[0]));
      ...
      }
      {
        fcf::Variant args[2] = {3, "2"};
        int result = 0;
        fcf::Type<int>().specificatorUniversalCall<fcf::AddSpecificator>()(&result, &args[0], sizeof(args) / sizeof(args[0]));
      ...
      }
      {
        fcf::Variant args[2] = {3, "2"};
        int result = 0;
        fcf::Type<int>().specificatorUniversalCall<fcf::MulSpecificator>()(&result, &args[0], sizeof(args) / sizeof(args[0]));
