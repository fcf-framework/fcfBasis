#ifndef _FCF_BASIS__BITS__PART_CALL__CALL_FUNCTION_HPP___
#define _FCF_BASIS__BITS__PART_CALL__CALL_FUNCTION_HPP___
...
namespace fcf{
  ...
  inline void call(const CallOptions& a_callOptions, const char* a_functionName, const TArgPack& ... a_argPack) {
    Call dc;
    CallSeeker<void, TArgPack...>{a_callOptions}(a_functionName, &dc, a_argPack...);
...
#endif // #ifndef _FCF_BASIS__BITS__PART_CALL__CALL_FUNCTION_HPP___
