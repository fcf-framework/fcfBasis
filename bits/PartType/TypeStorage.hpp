#ifndef _FCF_BASIS__BITS__PART_TYPE__TYPE_STORAGE_HPP___
#define _FCF_BASIS__BITS__PART_TYPE__TYPE_STORAGE_HPP___
...
namespace fcf{
  ...
  TypeInfo* TypeStorage::insert(const TypeInfo& a_ti, bool a_autoIndex, TypeIndex a_baseIndex) {
    ...
    if (nit == _ns.end()) {
      ...
      SPTypeInfo spti(new TypeInfo(typeIndex, a_ti.name, a_ti.flags, a_ti.size, a_ti.variantInnerSize));
...
#endif // #ifndef _FCF_BASIS__BITS__PART_TYPE__TYPE_STORAGE_HPP___
