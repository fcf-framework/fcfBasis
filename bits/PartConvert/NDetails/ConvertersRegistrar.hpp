#ifndef _FCF_BASIS__BITS__PART_CONVERT__NDETAILS__CONVERTERS_REGISTRAR_HPP___
#define _FCF_BASIS__BITS__PART_CONVERT__NDETAILS__CONVERTERS_REGISTRAR_HPP___

#include <tuple>
#include "../../../PartType.hpp"
#include "../../../bits/PartConvert/ConverterRegistration.hpp"
...
namespace fcf {
  ...
  struct ConvertersRegistrarItem<TCrossConvert, TCurrent, true, true> {
    ...
    void operator()(const TItem&){
      converterRegistration<TCurrent, TItem>();
      converterRegistration<TItem, TCurrent>();
    }
  };
...
#endif // #ifndef _FCF_BASIS__BITS__PART_CONVERT__NDETAILS__CONVERTERS_REGISTRAR_HPP___
